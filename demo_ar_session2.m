...
tt_dat_dis = []; ttls_dis = [];
for ci = 1:80
    tt_dat_dis = [tt_dat_dis Tt_dataMatrix(:,1+6*(ci-1):1+6*(ci-1))];
    tt_dat_dis = [tt_dat_dis Tt_dataMatrix(:,4+6*(ci-1):4+6*(ci-1))];
...
tt_dat_dil = []; ttls_dil = [];
for ci = 1:80
    tt_dat_dil = [tt_dat_dil Tt_dataMatrix(:,2+6*(ci-1):3+6*(ci-1))];
    tt_dat_dil = [tt_dat_dil Tt_dataMatrix(:,5+6*(ci-1):6+6*(ci-1))];
...
tt_dat_exp = []; ttls_exp = [];
for ci = 1:80
    tt_dat_exp = [tt_dat_exp Tt_dataMatrix(:,2+7*(ci-1):4+7*(ci-1))];
...
tt_dat_ill = []; ttls_ill = [];
for ci = 1:80
    tt_dat_ill = [tt_dat_ill Tt_dataMatrix(:,5+7*(ci-1):7+7*(ci-1))];
